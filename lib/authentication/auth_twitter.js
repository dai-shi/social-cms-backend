...
function getUserIdForPassportTwitter(options, profile, twitter_user_id, twitter_user_name, twitter_access_token, callback) {
...
function setTwitterUsername(options, profile, callback) {
...
function middleware(options) {
  ...
  passport.use(new PassportTwitterStrategy({
    ...
    console.log(profile);
    getUserIdForPassportTwitter(options, profile, profile.id, profile.name, access_token, function(err, user_id) {
      done(err, user_id);
      // setTwitterUsername(options, profile, function(err) {
      //
      //   done(err, profile);
      // });
    });
